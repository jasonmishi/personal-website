...
<div>
    <video class="project-image" id="video1" poster="" preload autoplay loop muted>
...
<div class="project-nav">
    <div class="container">
        <div class="row">
            <span onclick="javascript:location.href='../projects/project-2.html'"><ion-icon name="arrow-back"></ion-icon>previous</span>
            <span onclick="javascript:location.href='../projects/project-4.html'">next<ion-icon name="arrow-forward"></ion-icon></span>
        </div>
    </div>
</div>

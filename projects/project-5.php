    ...
    <div class="hero-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="wow fadeInUp" data-wow-delay="1s">Maze Generator</h1><br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <h6 class="wow fadeInUp" data-wow-delay="1.5s">6 Mar 2020</h6>
                    </div>

                    <div class="col-lg-4">
                        <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                        <h6 class="wow fadeInUp" data-wow-delay="1.7s">10 Mar 2020</h6>
                    </div>
                </div>
                <br>
